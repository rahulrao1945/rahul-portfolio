            ...
            {sent ? (
              <div className="flex flex-col items-center justify-center text-center py-10">
                ...
                <p className="mt-2 text-sm text-[var(--color-text-muted)] max-w-xs">
                  This form isn't connected to a backend yet — see the note below
              ...
              <>
                <div>
                  <label
                    htmlFor="name"
                    className="block text-xs font-mono text-[var(--color-text-muted)] mb-2"
                  >
                    Name
                  </label>
                ...
                <p className="text-[11px] text-[var(--color-text-faint)] leading-relaxed">
                  This is a frontend-only form. To make it actually deliver
                  messages, connect a service like{" "}
                  ...
                  , or your own API endpoint inside{" "}
                  <code className="font-mono">handleSubmit</code> in{" "}
