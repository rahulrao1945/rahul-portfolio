...
// so these are small inline SVG stand-ins sized to match lucide's API.

export function GithubIcon({ size = 18, strokeWidth, className = "", ...rest }) {
  return (
    <svg
      width={size}
      height={size}
...
export function LinkedinIcon({ size = 18, strokeWidth, className = "", ...rest }) {
  return (
    <svg
      width={size}
      height={size}
